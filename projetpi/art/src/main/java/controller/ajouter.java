...
public class ajouter {
    ...
    void ajouterLivraison(ActionEvent event) {
        ...
        try {
            ...
            livraison p = new livraison(tfdate.getText(), tfadresse.getText(), tfstatus.getText(),newfrais,Integer.parseInt(tfnom.getText()), Integer.parseInt(tfcommande.getText()));
  ...
  /*  @FXML
    ...
    void modifierLivraison(ActionEvent event) {
        ...
        try {
            ...
            livraison p = new livraison(Integer.parseInt(tfid.getText()) , tfdate.getText(), tfadresse.getText(), tfstatus.getText(),newfrais,Integer.parseInt(tfnom.getText()) , Integer.parseInt(tfcommande.getText()) );
            servicePerson sp = new servicePerson();
            sp.updateOne(p);
            Parent root = FXMLLoader.load(getClass().getResource("/views/livraison.fxml"));
            Stage window =(Stage) btnajouter.getScene().getWindow();
