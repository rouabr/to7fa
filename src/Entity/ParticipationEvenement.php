 ...
 *
 * @ORM\Table(name="participation_evenement", indexes={@ORM\Index(name="fk_event_participation", columns={"id_event"}), @ORM\Index(name="fk_user_participation", columns={"id_user"})})
 * @ORM\Entity
 */
