...
public class ReservationBackFXML {
    ...
    @FXML
    private ChoiceBox<String> tfnommuseereservation1;
    @FXML
    ...
    void initialize() {
        ...
        tfnommuseereservation1.getItems().addAll(museumNames);
...
// Set the SpinnerValueFactory to the Spinner
    ...
    void genererPDF(ActionEvent event) {
        try {
            ...
            fileChooser.setInitialFileName("liste_utilisateurs_reservations.pdf");
            ...
            if (file != null) {
                String museeSelectionne = tfnommuseereservation1.getValue();
                GeneratePdf.generatePDF(museeSelectionne, file);
